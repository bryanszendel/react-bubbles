...
A token is used to validate whether or not a user has approval to view certain content. A token is retrieved via login and is stored in the user's browser local storage.
